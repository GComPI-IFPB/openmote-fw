...
#define VREG_CTRL_PORT          ( GPIO_B_BASE )
#define VREG_CTRL_PIN           ( GPIO_PIN_2 )
...
// Leds
GpioConfig led_green_cfg = {LED_GREEN_PORT, LED_GREEN_PIN, 0, 0, 0, 1};
GpioConfig led_orange_cfg = {LED_ORANGE_PORT, LED_ORANGE_PIN, 0, 0, 0, 1};
GpioConfig led_red_cfg = {LED_RED_PORT, LED_RED_PIN, 0, 0, 0, 1};
GpioConfig led_yellow_cfg = {LED_YELLOW_PORT, LED_YELLOW_PIN, 0, 0, 0, 1};
