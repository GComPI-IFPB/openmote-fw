...
#define LED_GREEN_PERIPH            ( RCC_AHBPeriph_GPIOD )
...
#define LED_ORANGE_PERIPH           ( RCC_AHBPeriph_GPIOD )
...
#define LED_BLUE_PERIPH             ( RCC_AHBPeriph_GPIOD )
...
#define LED_YELLOW_PERIPH           ( RCC_AHBPeriph_GPIOD )
